---
title: "R3almCrowd_Documentation — Data Lineage"
...
For R3almCrowd_Documentation, likely data classes include documents, metadata, provenance, versions, and access events. Each material field or derived result must be traceable to a source, collection time, validation rule, transformation version, destination, retention rule, and accountable owner.

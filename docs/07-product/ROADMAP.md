---
title: "R3almCrowd_Documentation — Roadmap"
...
| 1 — Core workflow | capture → classify → review → version → retrieve works end to end in an isolated environment | Acceptance and failure-path tests | Planned |

---
title: "R3almCrowd_Documentation — Integration Map"
...
| Primary data store | Bidirectional | documents, metadata, provenance, versions, and access events | Workload identity / secret | Data owner | TBD |

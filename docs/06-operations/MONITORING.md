---
title: "R3almCrowd_Documentation — Monitoring"
...
Monitor availability, latency, error rate, saturation, and the success rate and duration of the primary workflow **capture → classify → review → version → retrieve**. Add dependency health and data freshness for every critical source.

---
title: "R3almCrowd_Documentation — Data Governance"
...
Potential data includes documents, metadata, provenance, versions, and access events. Actual collection must be derived from verified interfaces, schemas, telemetry, and integrations, then entered in the data inventory.
...
| Artifact content/state | Product workflow | TBD | TBD | Domain-specific | TBD |

---
title: "R3almCrowd_Documentation — Security"
...
Protect documents, metadata, provenance, versions, and access events; prevent unauthorized workflow transitions; preserve availability and integrity; and produce evidence sufficient to investigate material events.
...
Assess account takeover, privilege escalation, injection, cross-tenant access, secret leakage, supply-chain compromise, unsafe file or URL handling, replay, denial of service, dependency outage, and integrity loss. Add domain-specific abuse cases for records, documentation, and institutional knowledge.
